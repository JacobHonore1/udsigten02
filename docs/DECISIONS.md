...
- **Boliger**: gallery udvidet fra 3 til 6 billeder (fire Town Houses + to Lejligheder). `boliger.html`s hero-billede skiftet til `lejligheder_02.jpg` (ikke eksplicit dækket af mappingen — valgt fordi siden handler om lejligheder).
