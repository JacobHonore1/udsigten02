# Udsigten02 — Projektkontekst for Codex

Dette er kontekstfilen Codex læser automatisk når den starter i dette repo. Hold den opdateret — den er "hukommelsen" mellem sessioner.
...
## Vigtigt for Codex at vide

- Brugeren arbejder ikke selv med kode — al kommunikation sker via prompts skrevet af en anden Codex-instans (i en chat-app) og indsat direkte i denne terminal. Forklar derfor ikke "hvorfor" i lange baner; udfør ændringerne præcist som beskrevet i promptet.
...
- Denne fil (`AGENTS.md`) — opdater designsystem-sektionen hvis farver, fonte eller layout-regler ændres permanent
